...
** @brief
**         Flash module.
**         This module contains code for Flash control.
*/
/*!
...
static bool LaunchCommand(TFCCOB* commonCommandObject)  /*!< Sets up command (pg. 806) */
{
  ...
  if (FTFE_FSTAT & FTFE_FSTAT_ACCERR_MASK | FTFE_FSTAT_FPVIOL_MASK) /*!< check if flag violation */
  {
    FTFE_FSTAT = FTFE_FSTAT_ACCERR_MASK | FTFE_FSTAT_FPVIOL_MASK; /*!< clear old errors write 0x30 to FSTAT REGISTER */
  }
