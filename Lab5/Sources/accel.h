...
TAccelMode CurrentMode; /*!< to keep track of the current mode, polling or interrupt*/
TAccelData XYZstruct[3]; /*!< array of 3 sets of data to find the median */
uint8_t TempArray[3]; /*!< temporary array made global to be accessed by ISR's callback functions - used to read the data and compare with the old values or to be sent */
TAccelData OldXYZ[3];
