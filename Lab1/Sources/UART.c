...
**     Date/Time   : 2019-03-21, 13:52, # CodeGen: 0
**     Abstract    :
**         UART module
**     Settings    :
**     Contents    :
...
** @brief
**         UART module.
**         This module contains code for UART Communication .
*/
/*!
...
bool UART_Init(const uint32_t baudRate, const uint32_t moduleClk) {
  ...
  UART_C4_BRFA(32*(moduleClk%(sampleRate*baudRate))/(sampleRate*baudRate)); //Setting BRFA using modulus to calculate the remainder (pg. 1922, 1972)
